...
public class SimpleConvert {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(convert.toArray(num)));
        System.out.println(convert.toList(num));
        System.out.println(convert.toSet(num));
        System.out.println(convert.toMap(num));
    }
}